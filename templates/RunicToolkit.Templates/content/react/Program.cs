...
var options = new ApplicationBridgeFrontendApplicationOptions(
    ...
    new BrowserHostOptions("runic-toolkitstarter-react"),
    new BrowserWindowOptions("main", "RunicToolkit Counter · React", 760, 680),
...
await using ApplicationBridgeFrontendApplication frontend =
    builder.UseApplicationBridge("React", options);
