...
var options = new MvvmFrontendApplicationOptions<CounterViewModel>(
    ...
    new BrowserHostOptions("webuitoolkitstarter-angular"),
    new BrowserWindowOptions("main", "WebUIToolkit Counter · Angular", 760, 680),
...
await using MvvmFrontendApplication frontend =
    builder.Angular.CreateApplication(options);
