...
{
    internal static CounterRenderModel Initial(CounterViewModel model) => Create(model);

    internal static CounterRenderModel Response(CounterViewModel model, HtmxRenderContext _) =>
        Create(model);
