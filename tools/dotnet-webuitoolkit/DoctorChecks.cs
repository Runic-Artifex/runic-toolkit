...
internal static class DoctorChecks
{
        ...
        DoctorProjectConfiguration project)
    {
        if (!project.FrontendEnabled)
        {
            checks.Add(Fail(
                "frontend-sdk",
                "WebUIToolkit.Frontend.Sdk is not enabled for the selected project.",
                "Reference/import WebUIToolkit.Frontend.Sdk and set WebUIToolkitFrontendEnabled=true."));
            return;
        }
        ...
        if (!project.NodeEnabled && !project.CwhtmlEnabled)
        {
            checks.Add(Fail(
                "frontend-sdk",
                "Neither the Node/Vite nor cwhtml frontend pipeline is enabled.",
                "Enable WebUIToolkitFrontendNodeEnabled or WebUIToolkitFrontendCwhtmlEnabled."));
            return;
        }
        ...
        DoctorProjectConfiguration project)
    {
        ...
        else if (!File.Exists(project.ViteConfigurationPath))
        {
            ...
            checks.Add(Fail(
                ...
                "Create the file or correct WebUIToolkitFrontendViteConfiguration."));
        }
        else
        {
            checks.Add(Pass(
            ...
            || entry.Contains('#'))
        {
            checks.Add(Fail(
                ...
                "Set WebUIToolkitFrontendViteDevServerEntry to a path such as /src/main.ts."));
            return;
        }
        ...
        if (!File.Exists(entryPath))
        {
            checks.Add(Fail(
                ...
                "Create the entry module or correct WebUIToolkitFrontendViteDevServerEntry."));
            return;
        }
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!File.Exists(project.ContractSource))
        {
            checks.Add(Fail(
                ...
                "Create the contract source or correct WebUIToolkitFrontendContractSource."));
        }
                 ...
                 || !File.Exists(project.ContractTool))
        {
            checks.Add(Fail(
                ...
                "Restore WebUIToolkit.Frontend.Sdk or correct WebUIToolkitFrontendContractTool."));
        }
        else
        {
            checks.Add(Pass(
        ...
        if (!outputsConfigured)
        {
            checks.Add(Fail(
                ...
                "Set WebUIToolkitFrontendContractCSharpOutput and WebUIToolkitFrontendContractTypeScriptOutput."));
        }
        else if (!outputsExist)
        {
            checks.Add(Fail(
                ...
                "Run 'dotnet webuitoolkit dev' once to generate both contract outputs."));
        }
        else
        {
            checks.Add(Pass(
