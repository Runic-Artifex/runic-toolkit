...
/**
 * CsWebUi implementation of the `FrameChannel` contract from `@runic-artifex/mvvm`.
 *
...
export class CsWebUiFrameChannel {
  ...
  constructor(options = {}) {
    this.#bindingName = options.bindingName ?? "__runicToolkit_mvvm_send";
    this.#receiveFunctionName =
      options.receiveFunctionName ?? "__runicToolkit_mvvm_receive";
...
export async function waitForCsWebUiBinding(options = {}) {
  const bindingName = options.bindingName ?? "__runicToolkit_mvvm_send";
