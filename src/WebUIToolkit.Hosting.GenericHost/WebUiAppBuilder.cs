...
{
    private readonly GenericHostWebUIToolkitApplicationBuilder _host;
    private readonly string[] _arguments;
    private readonly Dictionary<Type, object> _features = [];
    private readonly List<Action<WebUIToolkitApplication>> _builtActions = [];
    private bool _built;
    ...
    public WebUiAppBuilder(string[]? arguments = null)
    {
        ...
        _host = new GenericHostWebUIToolkitApplicationBuilder(_arguments);
    }
    ...
    public WebUIToolkitApplicationBuilder Application => _host.Application;
    ...
    public WebUIToolkitApplication Build()
    {
        EnsureMutable();
        _built = true;
        WebUIToolkitApplication application = _host.Build();
        try
        {
            foreach (Action<WebUIToolkitApplication> action in _builtActions)
            {
                action(application);
            }
    ...
    {
        await using WebUIToolkitApplication application = Build();
