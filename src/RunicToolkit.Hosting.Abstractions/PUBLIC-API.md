# RunicToolkit.Hosting.Abstractions public API

Wave B declared source surface. All types are in the `RunicToolkit.Hosting`
...
public sealed record BrowserWindowOptions
{
    public BrowserWindowOptions(
        ...
        RunicToolkit.Desktop.DesktopBrowserProfile? browserProfile = null);
    ...
    public RunicToolkit.Desktop.DesktopBrowserProfile? BrowserProfile { get; }
}
...
public interface IBrowserWindowDesktopAdapter
{
    ...
    RunicToolkit.Desktop.DesktopCapabilityReport Capabilities { get; }
    ...
    ValueTask SetSizeAsync(
        RunicToolkit.Desktop.DesktopSize size,
        CancellationToken cancellationToken);
    ValueTask SetPositionAsync(
        RunicToolkit.Desktop.DesktopPosition position,
        CancellationToken cancellationToken);
    ValueTask CenterAsync(CancellationToken cancellationToken);
    ValueTask SetStateAsync(
        RunicToolkit.Desktop.DesktopWindowState state,
        CancellationToken cancellationToken);
