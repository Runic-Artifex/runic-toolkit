...
public static class PostGeneratorSemanticContract
{
    ...
    public const string Identity = "runic.toolkit.mvvm.post-generator-semantics/1";
...
public static class PostGeneratorSemanticCompiler
{
        ...
        IReadOnlyList<ResolvedSemanticMember> members)
    {
        ...
        var artifact = new GeneratedBindingArtifacts(
            ...
            manifest,
            fingerprint,
            "RunicToolkit.MVVM.PostGenerator." + fingerprint + ".g.cs",
            "runic.toolkit.mvvm.post-generator." + fingerprint + ".semantics.json");
        ...
        string fingerprint)
    {
        ...
        builder.Append("    [global::System.CodeDom.Compiler.GeneratedCodeAttribute(\"RunicToolkit.MVVM.Build\", \"");
