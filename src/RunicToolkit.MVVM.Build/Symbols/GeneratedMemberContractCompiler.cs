...
namespace RunicToolkit.MVVM.Build.Symbols;
...
public static class GeneratedMemberContractCompiler
{
        ...
        IReadOnlyList<ResolvedMember> members)
    {
        ...
        var artifact = new GeneratedBindingArtifacts(
            ...
            manifest,
            fingerprint,
            "RunicToolkit.MVVM.GeneratedMember." + fingerprint + ".g.cs",
            "runic.toolkit.mvvm.generated-member." + fingerprint + ".contract.json");
    ...
    private static string WriteCanonical(string metadataTypeName, IReadOnlyList<ResolvedMember> members)
    {
        ...
        AppendCanonical(builder, "format", "runic.toolkit.mvvm.generated-member-contract");
    ...
    {
        var builder = new StringBuilder();
        builder.Append("// <auto-generated/>\n#nullable enable\n\nnamespace RunicToolkit.MVVM.Generated\n{\n");
        builder.Append("    [global::System.CodeDom.Compiler.GeneratedCodeAttribute(\"RunicToolkit.MVVM.Build\", \"1\")]\n");
