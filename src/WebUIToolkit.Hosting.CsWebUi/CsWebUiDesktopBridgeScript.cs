...
internal static class CsWebUiDesktopBridgeScript
{
    internal const string Bootstrap = """
        (() => {
          if (globalThis.__webuitoolkitDesktop) return;
          const maxBytes = 16 * 1024 * 1024;
          const send = message => {
            const call = globalThis.__webuitoolkit_desktop_result(JSON.stringify(message));
          ...
          Object.defineProperty(globalThis, "__webuitoolkitDesktop", {
