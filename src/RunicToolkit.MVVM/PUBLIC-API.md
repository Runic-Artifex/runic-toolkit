...
Status: review baseline for `RunicToolkit.MVVM` and wire identity
`runic.toolkit.mvvm/1`. This baseline is not a publication grant; ADR 0004 keeps
publication blocked.
