...
public sealed class HostingGeneratorDiagnosticDescriptor
{
    ...
    /// </summary>
    /// <param name="id">The stable <c>RTKHOST</c> identity.</param>
    ...
    /// <summary>
    /// Gets the stable <c>RTKHOST</c> identity.
    /// </summary>
...
public static class HostingGeneratorDiagnostics
{
    ...
    /// </summary>
    public static HostingGeneratorDiagnosticDescriptor RTKHOST0001 { get; } = new(
        "RTKHOST0001",
    ...
    /// </summary>
    public static HostingGeneratorDiagnosticDescriptor RTKHOST0002 { get; } = new(
        "RTKHOST0002",
        HostingGeneratorDiagnosticSeverity.Error,
    ...
    /// </summary>
    public static HostingGeneratorDiagnosticDescriptor RTKHOST0003 { get; } = new(
        "RTKHOST0003",
        HostingGeneratorDiagnosticSeverity.Error,
    ...
    /// </summary>
    public static HostingGeneratorDiagnosticDescriptor RTKHOST0004 { get; } = new(
        "RTKHOST0004",
        HostingGeneratorDiagnosticSeverity.Error,
    ...
    /// </summary>
    public static HostingGeneratorDiagnosticDescriptor RTKHOST0005 { get; } = new(
        "RTKHOST0005",
    ...
    /// </summary>
    public static HostingGeneratorDiagnosticDescriptor RTKHOST0006 { get; } = new(
        "RTKHOST0006",
        HostingGeneratorDiagnosticSeverity.Error,
    ...
    /// </summary>
    public static HostingGeneratorDiagnosticDescriptor RTKHOST0007 { get; } = new(
        "RTKHOST0007",
        HostingGeneratorDiagnosticSeverity.Warning,
