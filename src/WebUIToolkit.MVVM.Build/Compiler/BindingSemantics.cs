...
{
    private const string SupportedProtocol = global::WebUIToolkit.MVVM.MvvmProtocol.Identity;
...
public static class BindingLanguage
{
    ...
    public const string Identity = "webuitoolkit.mvvm.bindings/1";

    /// <summary>The exact runtime protocol required by this language version.</summary>
    public const string RuntimeProtocolIdentity = global::WebUIToolkit.MVVM.MvvmProtocol.Identity;
}
