# RunicToolkit.Hosting.Build public API

Wave B declared source surface. Types are in the `RunicToolkit.Hosting.Build`
namespace and consume asset contracts from `RunicToolkit.Hosting`. Compiler-synthesized
