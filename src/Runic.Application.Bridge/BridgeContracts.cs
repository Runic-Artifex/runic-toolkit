...
public sealed record BridgeClientEnvelope
{
    ...
    /// <summary>Stable fingerprint of the generated contract manifest.</summary>
    public required string ContractFingerprint { get; init; }

    /// <summary>Monotonically increasing browser reconnect epoch.</summary>
...
public sealed record BridgeHostEnvelope
{
    ...
    /// <summary>Reconnect epoch accepted by the host for this envelope.</summary>
    public required long ConnectionEpoch { get; init; }
