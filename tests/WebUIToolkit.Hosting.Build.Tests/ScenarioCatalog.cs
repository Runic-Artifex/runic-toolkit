...
internal static class ScenarioCatalog
{
    ...
    {
        var builder = new FrontendAssetManifestBuilder();
        string missingRoot = Path.Combine(Path.GetTempPath(), "WebUIToolkit.Hosting.Build.Tests", Guid.NewGuid().ToString("N"));
    ...
    private sealed class ScopedTemporaryDirectory : IDisposable
    {
        ...
        {
            string parent = System.IO.Path.Combine(System.IO.Path.GetTempPath(), "WebUIToolkit.Hosting.Build.Tests");
