...
$smokeProject = Join-Path $projectDirectory 'RunicToolkit.Collections.AotSmoke.csproj'
$shippingProject = Join-Path $repositoryRoot 'src\RunicToolkit.Collections\RunicToolkit.Collections.csproj'
...
$executableName = if ($IsWindows) { 'RunicToolkit.Collections.AotSmoke.exe' } else { 'RunicToolkit.Collections.AotSmoke' }
