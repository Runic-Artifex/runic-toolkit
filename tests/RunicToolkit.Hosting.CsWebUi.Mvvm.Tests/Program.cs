...
namespace RunicToolkit.Hosting.CsWebUi.Mvvm.Tests;
...
internal static class Program
{
    ...
    private static async Task ProtocolRoundTrip()
    {
        ...
        Equal("__runicToolkit_mvvm_send", window.BindingName);
        ...
        Equal("__runicToolkit_mvvm_receive", callback.Sent.Single().Function);
