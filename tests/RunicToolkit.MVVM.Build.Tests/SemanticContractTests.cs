...
internal static class SemanticContractTests
{
    ...
    {
        BindingSemanticResult result = BindingCompiler.Compile(ParserContractTests.ValidSource, "settings.rtkmvvm");
        ...
        Assert.Equal("runic.toolkit.mvvm/1", model.ProtocolIdentity);
    ...
    private static void DuplicateIdMapsBothDeclarations()
    {
        const string source = """
            ...
            """;
        BindingSemanticResult result = BindingCompiler.Compile(source, "duplicate-id.rtkmvvm");
    ...
    private static void InvalidValidationTargetHasExactSpan()
    {
        const string source = """
            ...
            """;
        BindingSemanticResult result = BindingCompiler.Compile(source, "invalid-target.rtkmvvm");
        ...
        Assert.Equal("invalid-target.rtkmvvm", diagnostic.Span.LogicalPath);
    }
