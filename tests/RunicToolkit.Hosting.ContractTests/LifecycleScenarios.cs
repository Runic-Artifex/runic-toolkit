...
using RunicToolkit.Hosting.ContractTests.Fakes;
...
internal static partial class ScenarioCatalog
{
    ...
    private static async ValueTask InvalidIntentAsync()
    {
        ...
        AssertFailure(result, ApplicationFailureCategory.Usage, "RTKHOST1001", 2);
    ...
    private static async ValueTask ExternalCancellationAsync()
    {
        ...
        AssertFailure(result, ApplicationFailureCategory.Cancelled, "RTKHOST1301", 130);
        ContractAssert.EqualSequence(
            new[]
            {
                "host.start",
    ...
    private static async ValueTask PartialStartFailureAsync()
    {
        ...
        AssertFailure(result, ApplicationFailureCategory.HostStartup, "RTKHOST1102", 11);
    ...
    private static async ValueTask FirstFailurePrecedenceAsync()
    {
        ...
        ContractAssert.EqualSequence(
            new[] { "RTKHOST1401", "RTKHOST1403", "RTKHOST1404" },
    ...
    private static async ValueTask StartupTimeoutAsync()
    {
        ...
        AssertFailure(result, ApplicationFailureCategory.HostStartup, "RTKHOST1103", 11);
        ContractAssert.EqualSequence(
    ...
    private static async ValueTask StopTimeoutAsync()
    {
        ...
        ContractAssert.Equal("RTKHOST1402", kernel.SecondaryFailures[0].Code);
        ContractAssert.EqualSequence(
            new[]
            {
                "host.start",
    ...
    private static async ValueTask TotalShutdownTimeoutAsync()
    {
        ...
        AssertFailure(result, ApplicationFailureCategory.Shutdown, "RTKHOST1405", 40);
        ContractAssert.EqualSequence(
            new[]
            {
                "host.start",
    ...
    private static async ValueTask TotalDeadlineCapsActiveModeAsync()
    {
        ...
        ContractAssert.Equal(1, kernel.SecondaryFailures.Count);
        ContractAssert.Equal("RTKHOST1405", kernel.SecondaryFailures[0].Code);
        ContractAssert.EqualSequence(
            new[]
            {
                "host.start",
    ...
    private static async ValueTask StableKernelFailuresAsync()
    {
        ...
        AssertFailure(validation, ApplicationFailureCategory.Configuration, "RTKHOST1001", 10);
        ContractAssert.EqualSequence(
        ...
        AssertFailure(start, ApplicationFailureCategory.HostStartup, "RTKHOST1101", 11);
        ...
        AssertFailure(selection, ApplicationFailureCategory.Configuration, "RTKHOST1201", 10);
        ...
        AssertFailure(runner, ApplicationFailureCategory.UserInterface, "RTKHOST1202", 30);
    ...
    private static ValueTask StableExitCodesAsync()
    {
        ...
        {
            ApplicationFailure failure = new(category, "RTKHOST9999", "Safe test failure.");
