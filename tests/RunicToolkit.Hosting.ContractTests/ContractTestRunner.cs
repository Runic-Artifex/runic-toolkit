...
internal static class ContractAssert
{
    ...
    public static T IsType<T>(object? value, string? because = null)
    {
        ...
        {
            Fail($"Expected value of type {typeof(T).FullName}, found {value?.GetType().FullName ?? "<null>"}.{Reason(because)}");
    ...
    public static void NotCompleted(Task task, string? because = null)
    {
        ArgumentNullException.ThrowIfNull(task);
        False(task.IsCompleted, because);
    }

    public static void Completed(Task task, string? because = null)
    {
        ArgumentNullException.ThrowIfNull(task);
        True(task.IsCompleted, because);
    }
