...
internal static class HostileInputTests
{
    ...
    private static void RejectsOversizedSource()
    {
        ...
        BindingParseResult result = BindingParser.Parse(source, "limits/oversized.wutmvvm", limits);
        ...
        Assert.Equal("limits/oversized.wutmvvm", diagnostic.Span.LogicalPath);
    }
    ...
    private static void CapsDiagnosticFloods()
    {
        ...
        BindingParseResult result = BindingParser.Parse("@@@@@@@@@@@@@@@@", "limits/flood.wutmvvm", limits);
