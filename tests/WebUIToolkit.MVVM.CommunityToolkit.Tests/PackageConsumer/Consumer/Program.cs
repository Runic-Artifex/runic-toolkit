...
namespace WebUIToolkit.MVVM.CommunityToolkit.PackageConsumer;
...
internal static partial class Program
{
    public static async Task<int> Main()
    {
        ...
        bool noTooling = AppDomain.CurrentDomain.GetAssemblies().All(static assembly =>
            !assembly.GetName().Name!.Contains("WebUIToolkit.MVVM.Build", StringComparison.Ordinal)) &&
            !File.Exists(Path.Combine(AppContext.BaseDirectory, "WebUIToolkit.MVVM.Build.dll"));
